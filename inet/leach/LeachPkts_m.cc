...
int LeachControlPktDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "schedule") == 0) return baseIndex + 2;
    return base ? base->findField(fieldName) : -1;
}
...
void LeachControlPktDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    LeachControlPkt *pp = omnetpp::fromAnyPtr<LeachControlPkt>(object); (void)pp;
    switch (field) {
        case FIELD_packetType: pp->setPacketType((inet::LeachPktType)string2enum(value, "inet::LeachPktType")); break;
...
void LeachControlPktDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    LeachControlPkt *pp = omnetpp::fromAnyPtr<LeachControlPkt>(object); (void)pp;
    switch (field) {
        case FIELD_packetType: pp->setPacketType(static_cast<inet::LeachPktType>(value.intValue())); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'LeachControlPkt'", field);
    }
}
...
Register_Class(LeachSchPkt)

LeachSchPkt::LeachSchPkt() : ::inet::LeachControlPkt()
{
}

LeachSchPkt::LeachSchPkt(const LeachSchPkt& other) : ::inet::LeachControlPkt(other)
{
    copy(other);
}

LeachSchPkt::~LeachSchPkt()
{
}

LeachSchPkt& LeachSchPkt::operator=(const LeachSchPkt& other)
{
    if (this == &other) return *this;
    ::inet::LeachControlPkt::operator=(other);
    copy(other);
...
void LeachSchPkt::copy(const LeachSchPkt& other)
{
}

void LeachSchPkt::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::inet::LeachControlPkt::parsimPack(b);
}

void LeachSchPkt::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::inet::LeachControlPkt::parsimUnpack(b);
}

class LeachSchPktDescriptor : public omnetpp::cClassDescriptor
{
  private:
    mutable const char **propertyNames;
    enum FieldConstants {
  ...
  public:
    LeachSchPktDescriptor();
    virtual ~LeachSchPktDescriptor();
...
Register_ClassDescriptor(LeachSchPktDescriptor)

LeachSchPktDescriptor::LeachSchPktDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::LeachSchPkt)), "inet::LeachControlPkt")
{
    propertyNames = nullptr;
}

LeachSchPktDescriptor::~LeachSchPktDescriptor()
{
    delete[] propertyNames;
}

bool LeachSchPktDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<LeachSchPkt *>(obj)!=nullptr;
}

const char **LeachSchPktDescriptor::getPropertyNames() const
{
    if (!propertyNames) {
        static const char *names[] = {  nullptr };
        omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
...
const char *LeachSchPktDescriptor::getProperty(const char *propertyName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    return base ? base->getProperty(propertyName) : nullptr;
}

int LeachSchPktDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    return base ? 0+base->getFieldCount() : 0;
}

unsigned int LeachSchPktDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char *LeachSchPktDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
int LeachSchPktDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    return base ? base->findField(fieldName) : -1;
}

const char *LeachSchPktDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char **LeachSchPktDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char *LeachSchPktDescriptor::getFieldProperty(int field, const char *propertyName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
int LeachSchPktDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    LeachSchPkt *pp = omnetpp::fromAnyPtr<LeachSchPkt>(object); (void)pp;
    switch (field) {
        default: return 0;
    }
}

void LeachSchPktDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    LeachSchPkt *pp = omnetpp::fromAnyPtr<LeachSchPkt>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'LeachSchPkt'", field);
    }
}

const char *LeachSchPktDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string LeachSchPktDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void LeachSchPktDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    LeachSchPkt *pp = omnetpp::fromAnyPtr<LeachSchPkt>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'LeachSchPkt'", field);
    }
}

omnetpp::cValue LeachSchPktDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    LeachSchPkt *pp = omnetpp::fromAnyPtr<LeachSchPkt>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'LeachSchPkt' as cValue -- field index out of range?", field);
    }
}

void LeachSchPktDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
const char *LeachSchPktDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
omnetpp::any_ptr LeachSchPktDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void LeachSchPktDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
