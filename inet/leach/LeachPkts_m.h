...
/**
 * Enum generated from <tt>inet/routing/leach/LeachPkts.msg:25</tt> by opp_msgtool.
 * <pre>
 * //
...
/**
 * Class generated from <tt>inet/routing/leach/LeachPkts.msg:33</tt> by opp_msgtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/routing/leach/LeachPkts.msg:38</tt> by opp_msgtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/routing/leach/LeachPkts.msg:45</tt> by opp_msgtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/routing/leach/LeachPkts.msg:49</tt> by opp_msgtool.
 * <pre>
 ...
 * </pre>
 */
class INET_API LeachSchPkt : public ::inet::LeachControlPkt
{
  protected:

  private:
    void copy(const LeachSchPkt& other);

  protected:
    bool operator==(const LeachSchPkt&) = delete;

  public:
    LeachSchPkt();
    LeachSchPkt(const LeachSchPkt& other);
    virtual ~LeachSchPkt();
    LeachSchPkt& operator=(const LeachSchPkt& other);
    virtual LeachSchPkt *dup() const override {return new LeachSchPkt(*this);}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const override;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b) override;
};

inline void doParsimPacking(omnetpp::cCommBuffer *b, const LeachSchPkt& obj) {obj.parsimPack(b);}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, LeachSchPkt& obj) {obj.parsimUnpack(b);}

/**
 * Class generated from <tt>inet/routing/leach/LeachPkts.msg:53</tt> by opp_msgtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/routing/leach/LeachPkts.msg:58</tt> by opp_msgtool.
 * <pre>
...
template<> inline inet::LeachSchPkt *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::LeachSchPkt*>(ptr.get<cObject>()); }
